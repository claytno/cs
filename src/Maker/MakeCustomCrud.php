...
final class MakeCustomCrud extends AbstractMaker
{
    ...
    public function __construct(private DoctrineHelper $doctrineHelper, private CustomFormTypeRenderer $formTypeRenderer)
    {
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $generator->generateController(
            ...
            getcwd() .'/src/Maker/crud/controller/Controller.tpl.php',
            array_merge([
        ...
        foreach ($templates as $template => $variables) {
            $generator->generateTemplate(
                ...
                getcwd() . '/src/Maker/crud/templates/'.$template.'.tpl.php',
                $variables
            );
        }
